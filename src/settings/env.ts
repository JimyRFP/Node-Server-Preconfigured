...
const ENV={
    ...
    DATABASE:{
        ...
        port:(custom_env.DATABASE&&custom_env.DATABASE.PORT)?custom_env.DATABASE.PORT:process.env.DATABASE_PORT||5432,
        host:(custom_env.DATABASE&&custom_env.DATABASE.HOST)?custom_env.DATABASE.HOST:process.env.DATABASE_HOST||'localhost',
        database:(custom_env.DATABASE&&custom_env.DATABASE.DATABASE)?custom_env.DATABASE.DATABASE:process.env.DATABASE_DATABASE||'postgres',
        username:(custom_env.DATABASE&&custom_env.DATABASE.USERNAME)?custom_env.DATABASE.USERNAME:process.env.DATABASE_USERNAME||'postgres',
